...
(*.[0-9]*)
	...
	if test ! -f /home/czh/.emacs.d/elisp/GNUglobal4Linux/global-6.5.5/ncurses-6.0/man_alias.sed ; then
cat >>/home/czh/.emacs.d/elisp/GNUglobal4Linux/global-6.5.5/ncurses-6.0/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /home/czh/.emacs.d/elisp/GNUglobal4Linux/global-6.5.5/ncurses-6.0/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /home/czh/.emacs.d/elisp/GNUglobal4Linux/global-6.5.5/ncurses-6.0/man_alias.sed | sort -u; test $inalias = $nCurses && echo curses`
	cf_target=`grep "^$cf_source" /home/czh/.emacs.d/elisp/GNUglobal4Linux/global-6.5.5/ncurses-6.0/man/man_db.renames | mawk '{print $2}'`
	...
	sed	-f /home/czh/.emacs.d/elisp/GNUglobal4Linux/global-6.5.5/ncurses-6.0/man_alias.sed \
		< $i | sed -f /home/czh/.emacs.d/elisp/GNUglobal4Linux/global-6.5.5/ncurses-6.0/edit_man.sed >$TMP
