...
int main(void)
{
 ...
 call_int attroff (0);
 call_# 41 "_17520.c" 3 4;
 call_ ((void *)0);
 call_# 41 "_17520.c";
 call_int attron (0);
 call_# 47 "_17520.c" 3 4;
 call_ ((void *)0);
 call_# 47 "_17520.c";
 call_int attrset (0);
 ...
 call_# 336 "_17520.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 336 "_17520.c";
 call_ has_colors ();
 call_# 342 "_17520.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 342 "_17520.c";
 call_ has_ic ();
 call_# 348 "_17520.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 348 "_17520.c";
 call_ has_il ();
 call_int hline (a1, 0);
 call_void idcok (WINDOW * a1, ;
 call_# 360 "_17520.c" 3 4;
 call_ ;
 call_# 360 "_17520.c";
 call_ 0);
 call_int idlok (WINDOW * a1, ;
 call_# 367 "_17520.c" 3 4;
 call_ ;
 call_# 367 "_17520.c";
 call_ 0);
 call_void immedok (WINDOW * a1, ;
 call_# 373 "_17520.c" 3 4;
 call_ ;
 call_# 373 "_17520.c";
 call_ 0);
 call_chtype inch ();
 ...
 call_void use_env (;
 call_# 1197 "_17520.c" 3 4;
 call_ ;
 call_# 1197 "_17520.c";
 call_ 0);
 call_void use_tioctl (;
 call_# 1204 "_17520.c" 3 4;
 call_ ;
 call_# 1204 "_17520.c";
 call_ 0);
 call_int vidattr (0);
 ...
 call_# 1285 "_17520.c" 3 4;
 call_ ((void *)0);
 call_# 1285 "_17520.c";
 call_int wattroff (WINDOW * a1, 0);
 call_# 1291 "_17520.c" 3 4;
 call_ ((void *)0);
 call_# 1291 "_17520.c";
 ...
 call_# 1654 "_17520.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 1654 "_17520.c";
 call_ is_cleared (WINDOW * 0);
 call_# 1660 "_17520.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 1660 "_17520.c";
 call_ is_idcok (WINDOW * 0);
 call_# 1666 "_17520.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 1666 "_17520.c";
 call_ is_idlok (WINDOW * 0);
 call_# 1672 "_17520.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 1672 "_17520.c";
 call_ is_immedok (WINDOW * 0);
 call_# 1678 "_17520.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 1678 "_17520.c";
 call_ is_keypad (WINDOW * 0);
 call_# 1684 "_17520.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 1684 "_17520.c";
 call_ is_leaveok (WINDOW * 0);
 call_# 1690 "_17520.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 1690 "_17520.c";
 call_ is_nodelay (WINDOW * 0);
 call_# 1696 "_17520.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 1696 "_17520.c";
 call_ is_notimeout (WINDOW * 0);
 call_# 1702 "_17520.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 1702 "_17520.c";
 call_ is_pad (WINDOW * 0);
 call_# 1708 "_17520.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 1708 "_17520.c";
 call_ is_scrollok (WINDOW * 0);
 call_# 1714 "_17520.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 1714 "_17520.c";
 call_ is_subwin (WINDOW * 0);
 call_# 1720 "_17520.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 1720 "_17520.c";
 ...
 call_# 1932 "_17520.c" 3 4;
 call_ ;
 call_# 1932 "_17520.c";
 call_ 0);
#endif
#if USE_SP_FUNC_SUPPORT
 call_# 1940 "_17520.c" 3 4;
 call_NCURSES_BOOL ;
 call_# 1940 "_17520.c";
